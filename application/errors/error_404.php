...
<body>
	<div class="container text-center">
		<div class="logo-404">
			<a href="index.html"><img src="<?php echo base_url(); ?>public/default/images/home/logo.png" alt="" /></a>
		</div>
		<div class="content-404">
			<img src="<?php echo base_url(); ?>public/default/images/404/404.png" class="img-responsive" alt="" width="30%" />
			<h1><b>OPPS!</b> We Couldn’t Find this Page</h1>
			<p>Uh... So it looks like you break something. The page you are looking for has up and Vanished.</p>
			<h2><a href="<?php echo base_url(); ?>default/home">Bring me back Home</a></h2>
		</div>
	</div>
